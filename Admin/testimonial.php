...
<head>
    ...
    <title style>Testimonial Management</title>
    <style>
        /* Modal CSS styles */
        .modal {
            display: none;
...
<div class="col-sm-12 mt-6">
    <p class="bg-dark text-white p-2">List of Testimonial</p>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
        ...
        <?php else: ?>
            <p class="text-dark p-2 fw-bolder">No Testimonial found.</p>
        <?php endif; ?>
    </div>

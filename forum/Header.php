...
<head>
    ...
    <link rel="stylesheet" href="/ethioleant/Inc/Header.css">
    <link rel="stylesheet" href="/ethioleant/CSS/responsiveness.css">
    <link rel="stylesheet" href="https://unicons.iconscout.com/release/v2.1.6/css/unicons.css">
</head>
<body>
    <!-- Navigation Bar --><h4 class="title">Ethio learn <br> <h5>Educational Center</h5> </h4>
    <nav>
        <div class="container nav__container">
            ...
            <ul class="nav__menu">
                ...
                <li>
                    <a class="custom__links" href="forum/indexx.php">forum</a>
                </li>

...
if (isset($_POST['reset'])) {
    ...
    if (empty($email)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $stmt = $conn->prepare("UPDATE students SET reset_token=?, reset_expiry=? WHERE stu_email=?");
            ...
            if ($stmt->execute()) {
                ...
                try {
                    ...
                    $mail->Body = '<p>Hi,</p>' .
                        ...
                        '<p><a href="http://localhost/ethiolearn/reset_password.php?token=' . $reset_token . '">Reset Password</a></p>' .

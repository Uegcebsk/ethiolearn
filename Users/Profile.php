...
if (isset($_REQUEST['updateStuNameBtn'])) {
    if (($_REQUEST['stuName'] == "")) {
        $passmsg = '<div class="alert alert-warning col-sm-6 mx-auto mt-2" role="alert">All Field Required</div>';
    } else {
        ...
        if ($conn->query($sql) == TRUE) {
            ...
            $passmsg = '<div class="alert alert-warning col-sm-6 mx-auto mt-2" role="alert">Updated Failed</div>';
        }
    }
}
?>

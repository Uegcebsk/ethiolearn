...
if (isset($_SESSION['stu_id'])) {
    ...
    // Fetch all students enrolled in the same courses as the current student
    ...
    $stmt_students->bind_param("ii", $student_id, $student_id);
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            <div class="col-md-8 offset-md-2">
                <?php
                // Retrieve the most recent message from each sender (including lecturers)
                ...
                $stmt_recent_messages->bind_param("i", $student_id);
                ...
                ?>
                        <a href="inbox_detail_student.php?id=<?php echo $row_recent_message['message_id']; ?>" class="text-decoration-none">
...
<?php
    ...
    // Redirect to login page if student ID is not set in session

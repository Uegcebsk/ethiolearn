...
<div class="container" style="padding:5%;">
    <div class="col-sm-12 mt-5 bg-transparent carousel-fade ms-5">
    ...
    if (isset($_SESSION["exam_start"])) {
        $date = date("Y-m-d H:i:s");
        if ($mark >= 0) {
            mysqli_query($conn, "INSERT INTO quiz_result(stu_id, exam_type, total_question, correct_answer, wrong_answer, exam_time, mark) VALUES ('$_SESSION[stu_id]','$_SESSION[exam_category]','$count','$correct','$wrong','$date','$mark')");
        }
